...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("role IN ('OWNER', 'ADMIN', 'MANAGER', 'DEVELOPER', 'VIEWER')", name="ck_org_members_role"),
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint("role IN ('ADMIN', 'MANAGER', 'DEVELOPER', 'VIEWER')", name="ck_org_invitations_role"),
    )
